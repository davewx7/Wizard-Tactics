...
%.o : src/%.cpp
	ccache g++ `sdl-config --cflags` -fno-inline-functions -g $(OPT) -DTIXML_USE_STL=1 -D_GNU_SOURCE=1 -D_REENTRANT -Wnon-virtual-dtor -Wreturn-type -fthreadsafe-statics -c $<
